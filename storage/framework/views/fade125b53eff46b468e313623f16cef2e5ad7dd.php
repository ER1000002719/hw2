...
<html>
    <head>
        ...
        <script src="<?php echo e(asset('js/Profile.js')); ?>" defer="true"></script>
    ...
    <body>
        ...
        <main>
            <div id='profilebox'>
                ...
                <div><h1>POST</h1><span><?php echo e($numPosts); ?></span></div>
                <div><h1>LIKE</h1><span><?php echo e($numLikes); ?></span></div>
                <div><h1>COMMENTI</h1><span><?php echo e($numComments); ?></span></div>
            </div>
